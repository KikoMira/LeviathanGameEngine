...
int main(int argcount, char* args[]){
    ...
    Logger mainLog("Pong" + std::string("Log.txt"));
    ...
    std::unique_ptr<AppDef> ProgramDefinition(AppDef::GenerateAppdefine(
            "./EngineConf.conf", "./Pong.conf", "./PongKeys.conf",
            &PongGame::CheckGameConfigurationVariables, &PongGame::CheckGameKeyConfigVariables));
...
#endif
    ProgramDefinition->SetMasterServerParameters(MasterServerInformation("PongMasters.txt", "Pong_" GAME_VERSIONS, "http://boostslair.com/", "/Pong/MastersList.txt", "PongCrecentials.txt", false)).
        SetApplicationIdentification(
        "Pong client version " GAME_VERSIONS, "Pong",
        "GAME_VERSIONS");
